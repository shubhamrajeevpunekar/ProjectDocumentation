...
#+attr_latex: :align |p{4cm}|p{8cm}|
|--------------------------+---------------------------------------------------------------------------------------------------------------------------------------|
| Time                     | Tasks                                                                                                                                 |
|--------------------------+---------------------------------------------------------------------------------------------------------------------------------------|
| 3-4 weeks (Month 1)      | Study of the commonly used machine learning frameworks and toolkits (PDNN, scikit-learn, tensorflow and pytorch)                      |
| 3-4 weeks (Month 2)      | Requirements engineering. Survey and problem statement formulation. Understanding the use cases.                                      |
| 5-6 weeks (Months 3,4)   | Testing different models. Comparison of classifier performance.                                                                       |
| 8-10 weeks(Months 5,6,7) | Implementation of the selected models. Testing with the robot under real life scenarios. Fine tuning classifiers with homebrewed data |
| 5-6 weeks (Months 7,8)   | Finding research avenues based on the project. Incorporating optimizations. Conferring with industry experts for improvement inputs   |
|--------------------------+---------------------------------------------------------------------------------------------------------------------------------------|
